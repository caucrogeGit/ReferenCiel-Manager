...
Le fichier `.scpro` ne doit pas être traité comme un fichier isolé ou comme un format à deviner à nouveau. Il fait partie d’une chaîne de transformation déjà cadrée :
