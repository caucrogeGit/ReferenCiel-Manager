...
cadré par un ticket à périmètre explicite.
La base de données est la vérité
...
- **Opt-ins Forge** : appelés via des façades ; le métier ne dépend pas de leur
  détail.
  Critiques d'abord (facades, rbac, mfa, markdown, fichier, pivot,
