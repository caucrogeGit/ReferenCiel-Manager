...
RéférenCiel Manager sert de **banc d'essai** au framework Forge (ADR-006).
Cette
...
| [018](retour-018-mvc-views-chemin-fige-par-generateurs-pas-de-regroupement.md) | `make:crud` fige `mvc/views/<snake>/` sans option de dossier → impossible de séparer les vues du cadre (6) de celles de l'app (37) sans contourner le générateur (F41) | À remonter |
