...
| [009](retour-009-flux-relation-many-to-one-casse-mariadb.md) | Flux `make:relation` (many_to_one) inapplicable sur MariaDB (colonne FK non générée, nom Pascal/snake, type `BIGINT` vs `UNSIGNED`) | À remonter |
