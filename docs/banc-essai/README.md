...
| [011](retour-011-make-relation-unicite-globale-noms-et-fk.md) | `make:relation` impose une unicité **globale** du nom de relation (F24) et de la colonne FK (F25) — schémas multi-pivots inexprimables avec des noms fidèles au dictionnaire | À remonter |
