...
| 02 | [Contrat du JSON canonique](ticket-02-contrat-json-canonique.md) : enveloppe commune + référentiel niveau-classe **à deux couches** (famille TNE CC1–CC9 + cible CIEL C01–C11 + mapping) | Sources | Rédigé — à exécuter |
