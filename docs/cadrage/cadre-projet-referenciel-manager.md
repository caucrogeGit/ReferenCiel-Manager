...
sur le framework Forge. Elle sert à **créer, organiser, affecter, suivre et
...
évaluation. Il peut s'inspirer de la logique CPRO sans en dépendre techniquement.
...
(ex. *JSON canonique CIEL 2TNE*). Il formalise l'extraction du référentiel Bac
...
on affecte une **version publiée**, jamais un brouillon mutable. Statuts :
