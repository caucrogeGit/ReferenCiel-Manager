...
Base regenerable de l'entite ResultatAttendu.
...
class ResultatAttenduBase:
    """Classe de base regenerable de ResultatAttendu."""

    def __init__(self, code, libelle, activite_id, created_at, updated_at, id=None):
        self.code = code
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "ResultatAttenduBase":
        return cls(
            id=data["id"],
            code=data["code"],
    ...
    def __repr__(self) -> str:
        return f"ResultatAttenduBase(id={self.id!r}, code={self.code!r}, libelle={self.libelle!r}, activite_id={self.activite_id!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
