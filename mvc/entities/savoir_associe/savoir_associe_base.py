...
Base regenerable de l'entite SavoirAssocie.
...
class SavoirAssocieBase:
    """Classe de base regenerable de SavoirAssocie."""
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "SavoirAssocieBase":
        return cls(
            id=data["id"],
    ...
    def __repr__(self) -> str:
        return f"SavoirAssocieBase(id={self.id!r}, libelle={self.libelle!r}, sequence_id={self.sequence_id!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
