...
Base regenerable de l'entite VersionParcours.
...
class VersionParcoursBase:
    """Classe de base regenerable de VersionParcours."""

    def __init__(self, version, statut, parcours_id, created_at, updated_at, id=None):
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "VersionParcoursBase":
        return cls(
            id=data["id"],
    ...
    def __repr__(self) -> str:
        return f"VersionParcoursBase(id={self.id!r}, version={self.version!r}, statut={self.statut!r}, parcours_id={self.parcours_id!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
