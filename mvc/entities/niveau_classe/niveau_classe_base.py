...
Base regenerable de l'entite NiveauClasse.
...
class NiveauClasseBase:
    """Classe de base regenerable de NiveauClasse."""
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "NiveauClasseBase":
        return cls(
            id=data["id"],
            code=data["code"],
    ...
    def __repr__(self) -> str:
        return f"NiveauClasseBase(id={self.id!r}, code={self.code!r}, intitule={self.intitule!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
