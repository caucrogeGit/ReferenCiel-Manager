...
Base regenerable de l'entite Competence.
...
class CompetenceBase:
    """Classe de base regenerable de Competence."""
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "CompetenceBase":
        return cls(
            id=data["id"],
            code=data["code"],
    ...
    def __repr__(self) -> str:
        return f"CompetenceBase(id={self.id!r}, code={self.code!r}, intitule={self.intitule!r}, referentiel_id={self.referentiel_id!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
