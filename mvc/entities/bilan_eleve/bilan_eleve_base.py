...
class BilanEleveBase:
    ...
    def __init__(self, appreciation_globale, statut, date_bilan, eleve_id, professeur_id, progression_sequence_id, created_at, updated_at, id=None, synthese=None):
