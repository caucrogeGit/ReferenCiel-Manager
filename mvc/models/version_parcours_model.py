...
INSERT       = "INSERT INTO version_parcours (Version, Statut, parcours_id, CreatedAt, UpdatedAt) VALUES (?, ?, ?, ?, ?)"
UPDATE       = "UPDATE version_parcours SET Version = ?, Statut = ?, parcours_id = ?, UpdatedAt = ? WHERE Id = ?"
...
def add_version_parcours(data):
    return insert(INSERT, (data["version"], data["statut"], data["parcours_id"], datetime.now(timezone.utc), datetime.now(timezone.utc),))


def update_version_parcours(id, data):
    execute(UPDATE, (data["version"], data["statut"], data["parcours_id"], datetime.now(timezone.utc), id))
