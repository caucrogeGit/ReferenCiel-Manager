...
def register_scenario_editeur_routes(router: Router) -> None:
    with router.group("/conception/scenario") as g:
        ...
        g.add("POST", "/{id}/supprimer", ScenarioEditeurController.supprimer, name="scenario_editeur-supprimer")
        ...
        g.add("GET", "/{id}/md", ScenarioEditeurController.telecharger_md, name="scenario_editeur-md")
        g.add("GET", "/{id}/json", ScenarioEditeurController.telecharger_json, name="scenario_editeur-json")
