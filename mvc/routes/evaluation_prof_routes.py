...
def register_evaluation_prof_routes(router: Router) -> None:
    with router.group("/evaluation") as g:
        ...
        g.add("POST", "/activite/{id}/critere/{cid}/niveau",
              EvaluationProfController.positionner, name="evaluation-critere-niveau")
        g.add("POST", "/activite/{id}/critere/{cid}/indicateurs",
              EvaluationProfController.cocher_indicateurs, name="evaluation-critere-indicateurs")
        g.add("POST", "/activite/{id}/notes", EvaluationProfController.notes, name="evaluation-activite-notes")
